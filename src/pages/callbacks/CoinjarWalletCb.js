...
class CoinjarWalletCb extends WalletForm {
  componentDidMount() {
    let params = queryString.parse(this.props.location.search)
    axios
      .post('/api/oauth2/coinjar_wallet', params)
...
export default connect(null, { notifyError, notifyInfo, checkSyncStatus })(withRouter(CoinjarWalletCb))
